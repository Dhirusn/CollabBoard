        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Snapshots_Boards_BoardId",
                        column: x => x.BoardId,
                        principalTable: "Boards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_BoardId_SentUtc",
                table: "ChatMessages",
                columns: new[] { "BoardId", "SentUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentBlocks_PageId_UpdatedUtc",
                table: "ContentBlocks",
                columns: new[] { "PageId", "UpdatedUtc" })
                .Annotation("Npgsql:IndexInclude", new[] { "X", "Y", "Width", "Height" });

            migrationBuilder.CreateIndex(
                name: "IX_ContentBlocks_Payload",
                table: "ContentBlocks",
                column: "Payload")
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperationLogs_BoardId_Timestamp",
                table: "OperationLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pages_BoardId_OrderIndex",
                table: "Pages",
                columns: new[] { "BoardId", "OrderIndex" });

            migrationBuilder.CreateIndex(
                name: "IX_Snapshots_BoardId_TakenUtc",
                table: "Snapshots",
